 ...
 */
public class OldCircleView extends View {
    ...
    public OldCircleView(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public OldCircleView(Context context) {
        this(context, null);
    }
     ...
     * @param defStyle
     */
    public OldCircleView(Context context, AttributeSet attrs, int defStyle) {
